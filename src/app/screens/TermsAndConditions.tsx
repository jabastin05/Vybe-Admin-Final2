        ...
        <div className="bg-white/80 dark:bg-[#1A1A1A] backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] rounded-2xl p-10 shadow-[0_2px_16px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
          <div className="prose dark:prose-invert max-w-none">
            <div className="space-y-8 text-black/80 dark:text-white/80">
              {/* Section 1 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">1. Acceptance of Terms</h2>
              ...
              {/* Section 2 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">2. Use of Services</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 3 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">3. User Accounts</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 4 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">4. Data Privacy</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 5 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">5. Intellectual Property</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 6 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">6. Limitation of Liability</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 7 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">7. Modifications to Terms</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 8 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">8. Contact Information</h2>
                <p className="text-[14px] leading-relaxed">
