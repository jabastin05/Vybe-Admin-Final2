        ...
        <div className="bg-white/80 dark:bg-[#1A1A1A] backdrop-blur-xl border border-black/[0.06] dark:border-white/[0.08] rounded-2xl p-10 shadow-[0_2px_16px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.3)]">
          <div className="prose dark:prose-invert max-w-none">
            <div className="space-y-8 text-black/80 dark:text-white/80">
              {/* Introduction */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">Introduction</h2>
              ...
              {/* Section 1 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">1. Information We Collect</h2>
                <p className="text-[14px] leading-relaxed mb-3">
                  We collect information that you provide directly to us, including:
                </p>
                <ul className="list-disc list-inside text-[14px] leading-relaxed space-y-2 mb-3">
              ...
              {/* Section 2 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">2. How We Use Your Information</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 3 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">3. Data Security</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 4 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">4. Data Sharing and Disclosure</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 5 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">5. Your Rights and Choices</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 6 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">6. Data Retention</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 7 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">7. Children's Privacy</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 8 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">8. Changes to This Privacy Policy</h2>
                <p className="text-[14px] leading-relaxed mb-3">
              ...
              {/* Section 9 */}
              <div>
                <h2 className="text-[20px] font-medium text-black dark:text-white mb-4">9. Contact Us</h2>
                <p className="text-[14px] leading-relaxed">
