...
const navItems: NavItem[] = [
  // { icon: LayoutDashboard, label: 'Dashboard', path: '/dashboard', accentColor: 'bg-gradient-to-br from-emerald-500 to-green-500 dark:bg-white' }, // Hidden from navigation
  ...
  { icon: Briefcase, label: 'Services', path: '/services', accentColor: 'bg-gradient-to-br from-emerald-500 to-green-500 dark:bg-white' },
  ...
  { icon: TrendingUp, label: 'Market Intelligence', path: '/market-intelligence', accentColor: 'bg-gradient-to-br from-emerald-500 to-green-500 dark:bg-white' },
      ...
      <div className="bg-white dark:bg-[#111111]/80 backdrop-blur-xl rounded-[32px] p-4 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] border border-black/[0.06] dark:border-white/[0.08]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            title="Logout"
          >
            <div className="relative w-[64px] h-[64px] rounded-[22px] flex items-center justify-center bg-black/[0.02] dark:bg-white/[0.02] hover:bg-red-50 dark:hover:bg-red-500/10 hover:scale-105 transition-all duration-300">
              <LogOut 
                className="w-6 h-6 text-black/40 dark:text-white/40 group-hover:text-red-500 dark:group-hover:text-red-400 transition-colors duration-300" 
                strokeWidth={1.5}
              />
            </div>
