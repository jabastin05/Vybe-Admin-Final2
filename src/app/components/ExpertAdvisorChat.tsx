...
export function ExpertAdvisorChat({ onClose, propertyContext }: ExpertAdvisorChatProps) {
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-[480px] bg-card dark:bg-neutral-900 border-l border-black/[0.06] dark:border-white/[0.08] shadow-[-8px_0_32px_rgba(0,0,0,0.12)] dark:shadow-[-8px_0_32px_rgba(0,0,0,0.6)] flex flex-col z-50">
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-black/[0.06] dark:border-white/[0.08] bg-gradient-to-r from-purple-500/5 to-blue-500/5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center shadow-lg">
            <Sparkles className="w-5 h-5 text-neutral-0" />
          </div>
          <div>
            <div className="text-small font-medium text-foreground dark:text-neutral-0">
              Expert Advisor
            </div>
            <div className="text-caption text-muted-foreground dark:text-neutral-0/50 flex items-center gap-1.5">
              <div className="w-1.5 h-1.5 rounded-full bg-primary-700 animate-pulse"></div>
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-xl bg-neutral-900/[0.03] dark:bg-card/[0.03] hover:bg-neutral-900/[0.08] dark:hover:bg-card/[0.08] flex items-center justify-center transition-colors"
          >
            <X className="w-4 h-4 text-neutral-700/80 dark:text-neutral-300/80" />
          </button>
        )}
      </div>
            ...
            {message.type === 'user' && (
              <div className="flex gap-3 justify-end">
                <div className="flex flex-col items-end max-w-[80%]">
                  <div className="px-4 py-3 rounded-2xl bg-gradient-to-br from-primary-700 to-green-500 text-neutral-0">
                    <p className="text-small leading-relaxed whitespace-pre-wrap">
                      {message.content}
                    </p>
                  </div>
                  <div className="text-caption text-muted-foreground dark:text-neutral-300/60 mt-1.5">
                    {message.timestamp.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
                  </div>
                </div>
                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-primary-700 to-green-500 flex items-center justify-center flex-shrink-0">
            ...
            {message.type === 'advisor' && (
              <div className="flex gap-3">
                <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center flex-shrink-0">
                  <Bot className="w-4 h-4 text-neutral-0" />
                </div>
                <div className="flex flex-col max-w-[85%]">
                  <div className="px-4 py-3 rounded-2xl bg-gradient-to-br from-black/[0.03] to-black/[0.06] dark:from-white/[0.03] dark:to-white/[0.06] border border-black/[0.06] dark:border-white/[0.08]">
                    <p className="text-small leading-relaxed text-foreground dark:text-neutral-0/95 whitespace-pre-wrap">
                  ...
                  {message.requiresConfirmation && message.confirmationData && (
                    <div className="mt-3 p-4 rounded-2xl bg-gradient-to-br from-orange-500/10 to-yellow-500/10 border border-orange-500/20">
                      <div className="flex items-start gap-2 mb-3">
                        ...
                        <div>
                          <div className="text-caption font-medium text-orange-600 dark:text-orange-400 uppercase tracking-wider mb-1">
                            Confirmation Required
                          </div>
                          <div className="text-caption text-foreground dark:text-neutral-0/95 font-medium mb-1">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="flex-1 px-3 py-2 rounded-xl bg-gradient-to-br from-primary-700 to-green-500 text-neutral-0 text-caption font-medium hover:shadow-lg transition-all flex items-center justify-center gap-1.5"
                            >
                            ...
                            <button
                              ...
                              className="px-4 py-2 rounded-xl bg-neutral-900/5 dark:bg-card/5 text-foreground/70 dark:text-neutral-0/70 text-caption font-medium hover:bg-neutral-900/10 dark:hover:bg-card/10 transition-all"
                            >
                              Cancel
                            </button>
                          </div>
                  ...
                  {message.escalationAvailable && (
                    <button
                      ...
                      className="mt-3 flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 text-caption font-medium hover:bg-blue-500/20 transition-all"
                    >
                    ...
                    <div className="mt-3 space-y-2">
                      {message.suggestions.map((suggestion, idx) => (
                        <button
                          ...
                          className="w-full text-left px-4 py-2.5 rounded-xl bg-card border border-black/[0.06] dark:border-white/[0.08] text-caption text-foreground/70 dark:text-neutral-0/70 hover:border-black/[0.12] dark:hover:border-white/[0.15] hover:bg-neutral-900/[0.02] dark:hover:bg-card/[0.02] transition-all flex items-center justify-between group"
                        >
          ...
          <div className="flex gap-3">
            ...
            <div className="px-4 py-3 rounded-2xl bg-gradient-to-br from-black/[0.03] to-black/[0.06] dark:from-white/[0.03] dark:to-white/[0.06] border border-black/[0.06] dark:border-white/[0.08]">
              <div className="flex gap-1.5">
                <div className="w-2 h-2 rounded-full bg-neutral-900/30 dark:bg-card/30 animate-pulse"></div>
                <div className="w-2 h-2 rounded-full bg-neutral-900/30 dark:bg-card/30 animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                <div className="w-2 h-2 rounded-full bg-neutral-900/30 dark:bg-card/30 animate-pulse" style={{ animationDelay: '0.4s' }}></div>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="px-6 py-4 border-t border-black/[0.06] dark:border-white/[0.08] bg-gradient-to-r from-black/[0.01] to-black/[0.02] dark:from-white/[0.01] dark:to-white/[0.02]">
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 rounded-2xl bg-card border border-black/[0.06] dark:border-white/[0.08] text-small text-foreground dark:text-neutral-0 placeholder:text-muted-foreground dark:placeholder:text-neutral-300/60 focus:outline-none focus:border-purple-500/50 dark:focus:border-purple-500/50 transition-colors"
          />
          <button
            onClick={() => handleSend(inputValue)}
            disabled={!inputValue.trim()}
            className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-neutral-0 hover:shadow-lg transition-all disabled:opacity-40 disabled:cursor-not-allowed"
          >
            <Send className="w-5 h-5" />
          </button>
        </div>
        <div className="text-caption text-muted-foreground dark:text-neutral-300/60 mt-2 text-center">
